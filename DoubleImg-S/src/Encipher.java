...
public class Encipher extends JFrame {
	...
	public Encipher(){
		...
		char c;
		// 解构
		for(int i = 0; i < t.length && i < 256; i++){
	...
	public void paint(Graphics g){
		...
		g.drawLine(5, 5, 5 + Cube.length * 64,5);
		g.drawLine(5, 5, 5,5 + Cube.length * 64);
		g.drawLine(5, 5 + Cube.length * 64, 5 + Cube.length * 64,5 + Cube.length * 64);
		g.drawLine(5, 5, 5,5 + Cube.length * 64);
		g.drawLine(5 + Cube.length * 64, 5, 5 + Cube.length * 64, 5 + Cube.length * 64);
