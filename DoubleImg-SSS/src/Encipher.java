...
public class Encipher extends JFrame {
	...
	public void paint(Graphics g){
		...
		g.drawLine(5, 5, 5 + Cube.length * 16,5);
		g.drawLine(5, 5, 5,5 + Cube.length * 16);
		g.drawLine(5, 5 + Cube.length * 16, 5 + Cube.length * 16,5 + Cube.length * 16);
		g.drawLine(5, 5, 5,5 + Cube.length * 16);
		g.drawLine(5 + Cube.length * 16, 5, 5 + Cube.length * 16, 5 + Cube.length * 16);
